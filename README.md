...
Please see [evaluation]([evaluation](https://github.com/FudanDISC/MASER/tree/main/src/evaluation)) for details about the evaluation datasets and evaluation scripts.
